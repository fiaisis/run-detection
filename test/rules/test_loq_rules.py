...
@pytest.mark.parametrize(("filename", "result"), [("LOQ00100002.nxs", "100002"), ("LOQ123456789.nxs", "123456789"),
                                                    ("LOQ.nxs", ""), ("LOQ00000.nxs", "")])
...
@pytest.mark.parametrize(("file_title", "sample_title", "result"), [
...
@pytest.mark.parametrize(("file_title", "result"), [
...
@pytest.mark.parametrize(("file_title", "can_title", "result"), [
